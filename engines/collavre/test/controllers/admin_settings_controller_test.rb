...
class AdminSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update settings" do
    sign_in_as(@admin, password: "password")
    patch collavre.admin_settings_path, params: { help_link: "https://new.example.com", auth_providers: [ "email" ] }
  ...
  test "password_min_length is clamped to floor of 8" do
    ...
    patch collavre.admin_settings_path, params: { password_min_length: 1, auth_providers: [ "email" ] }
  ...
  test "password_min_length is clamped to ceiling of 72" do
    ...
    patch collavre.admin_settings_path, params: { password_min_length: 100, auth_providers: [ "email" ] }
  ...
  test "password_min_length accepts valid value within range" do
    ...
    patch collavre.admin_settings_path, params: { password_min_length: 15, auth_providers: [ "email" ] }
