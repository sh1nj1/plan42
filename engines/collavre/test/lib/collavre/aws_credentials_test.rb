...
module Collavre
  ...
  class AwsCredentialsTest < ActiveSupport::TestCase
    ...
    test "s3 returns DB pair when both halves are set" do
      Collavre::IntegrationSetting.create!(key: "aws_s3_access_key_id", value: "DB-KEY", category: "aws")
      Collavre::IntegrationSetting.create!(key: "aws_s3_secret_access_key", value: "DB-SECRET", category: "aws")
    ...
    test "ses_smtp returns DB pair when both halves are set" do
      Collavre::IntegrationSetting.create!(key: "aws_ses_smtp_username", value: "db-u", category: "aws")
      Collavre::IntegrationSetting.create!(key: "aws_ses_smtp_password", value: "db-p", category: "aws")
