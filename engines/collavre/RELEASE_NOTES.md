...
### Changes
- a29c2e30 test: stabilize workspace UI timing (#1601)
- c2ed4789 test: isolate system tests from stale assets (#1600)
- 80f6714d fix: return to the originating list after editing an AI agent (#1598)
- 46790ba5 Fix topic scroll interruption on user input (#1596)
- a8b0310b fix: correlate command focus with its submission (#1597)
- 476e9dd0 Fix slash command popup focus after submit (#1595)
- c2238194 fix: prevent duplicate topic scroll after fullscreen exit (#1594)
- ddb0ffa4 Merge pull request #1581 from sh1nj1/fix/mobile-folded-corner
- 0fedd681 fix: return to contacts after updating AI agent
- 0a203ba4 fix(creatives): paint the empty-state disc as a gradient, not a rounded rect
- c00ec292 fix(collavre): cross-fade nav pill surfaces with opacity, not background
- 682db389 fix(creatives): straighten the empty-state tree icon connectors
- d29a4e1c fix: avoid Turbo scroll on gateway settings navigation
- 29b6c643 fix: show all creatives in the workspace tree (#1509)
- 10ba1cad Fix immediate channel chip removal (#1578)
- 3dc1a276 fix(navigation): send the Home button to the top level (#1576)
- 7b0fd20a feat: add topic move MCP tool (#1577)
- af5a6afd feat: add topic message creation tool (#1575)
- a387ad17 revert: compact mobile chat popup actions (#1574)
- a3e52ba8 fix: compact mobile chat popup actions (#1573)
- 5e9347b8 feat: add topic and topic-message MCP tools (#1569)
- 1e138794 fix(comments): stop the slash command menu blinking on every keystroke (#1571)
- de1c0bc1 fix: keep mobile chat open during topic list scroll (#1570)
- ae345899 feat: show unread badges in topic list (#1568)
- 536c7901 perf(comments): make read-pointer writes and receipt lookups batch-sized (#1566)
- 88c36b56 fix: align chat close action icon (#1567)
- 7bf716e5 feat: show topics with unread messages
- b6a767ad refactor: remove Android voice companion (#1551)
- 8eccc6b3 fix: stop a topic pick being reverted by the echo of its own save (#1560)
- 27c8e185 feat: introduce system event envelope and vocabulary (#1563)
- 58f5ff05 Fix Claude Channel presence routing (#1562)
- 6ceb3153 feat: gate PR complexity with a merge-base entity ratchet (#1538)
- 1e315c3f Fix topic list button toggle behavior (#1561)
- 6713ce50 fix: keep a topic pick from being reverted by a landing load (#1559)
- 6889e930 Reveal the leaf progress checkbox on row hover (#1558)
- b1968c20 feat: show the completion mark on completed leaf checkboxes (#1555)
- 6d053586 fix: keep topic list search box unfocused on mobile (#1556)
- a713c57e Show checkboxes for binary leaf creative progress (#1553)
- de7df969 fix: stabilize trigger status and workspace drawer tests (#1554)
- cd3aeb09 refactor: remove typo correction (#1549)
- 7cfd94b8 refactor: remove legacy inbox items (#1552)
- 88b09d2e refactor: remove category recommendation (#1550)
- 4596a5a4 fix: contain unbreakable creative content inside the workspace column (#1546)
- d395b203 feat: add unread counts to topic badges (#1545)
- 209e6549 refactor: remove the /work command and its workflow engine (#1542)
- 3b0a53d5 refactor: unify comment badge counts (#1544)
- 685ee47a fix: make agent gateway completion key optional (#1540)
- cc677862 fix: support Tauri desktop drag and drop (#1535)
- 07dcd688 fix: support desktop confirmations and downloads (#1537)
- cf362752 fix: disable unconsented desktop gateway setup (#1533)
- d923115e feat: complete desktop CLI proxy setup (#1527)
- f284ce54 feat: open archived topics from the topic strip (#1528)
- 16e0aeda fix(popup): fit anchored popups to the space beside the caret (#1530)
- bd2ceb46 feat: support custom Codex proxy authentication (#1526)
- 1e8661fa feat: restore the last visited Creative on launch (#1525)
- dab4e9a9 fix: remove duplicate workspace tree icon declarations (#1521)
- 5683cd6f fix: close workspace tree drawer on outside click (#1520)
- dd57950f fix: contain mobile tree overscroll (#1519)
- 270ed39f Fix mobile workspace tree swipe close (#1518)
- db16baf9 Fix mobile workspace tree drawer layering and icons (#1517)
- 6d5a3b26 feat: show the workspace tree as a drawer at one-panel widths (#1516)
- cf39c42f fix: isolate navigation registry tests (#1515)
- 7be79df5 feat: split agent workspace and credential identity axes (#1512)
- 4a725f78 fix: compare the skill archive against the skill it packages (#1514)
- 7a29af0a feat: re-register the workspace manifest from Sync now (#1513)
- dfa49dd1 feat: integrate CLI proxy agent gateways (#1507)
- 0b784733 fix: resolve duplicate migration version (#1508)
- 7279cbd4 fix: simplify actionable task empty-state label (#1504)
- f8c35e71 fix(collavre): navigate list filters via turbo frame instead of full reload (#1506)
- ecf55599 feat: persist AI agent model suggestions (#1505)
- b6401923 fix: keep sent chat message out of the input on IME send (#1502)
- e28522c1 feat: enable the three-column creative workspace by default (#1503)
- 7b1f7c3c feat: link default help to feature guide (#1501)
- e1c79a34 fix: remove stalled Creative inbox alerts (#1500)
- bb59b5a5 feat: tailor empty state for inbox System topic (#1497)
- 94579c3a feat: persist chat input drafts in localStorage (#1496)
- 81e95402 feat: add creative links to inline editors (#1494)
- 9e2c9a8a perf: lazily load workspace tree branches (#1495)
- 4701236f fix(ui): stop flashing the empty state before the creative tree loads (#1492)
- 53d88429 feat: add feature guides and show them in empty topics (#1489)
- b149dbb4 fix(ui): raise empty-state concept card text off the 8px token (#1490)
- 4db31775 feat: add actionable empty state to creative tree view (#1485)
- 9dae403a feat: replace empty chat state with feature discovery cards (#1486)
- 36e777f4 fix: decode HTML character references in plain-text creative labels (#1488)
- fc6ce075 fix(creatives): clear empty-state placeholder when a sub-creative is added (#1487)
- 7698e44b feat: add persistent three-column creative workspace (#1482)
- 34689157 Stabilize AI agent job execution: terminal-status cancellation, turn deadline, dedicated queue (#1468)
- 60cd1264 fix: allow email entry for public invitations (#1470)
- 12d3e3b9 fix: add Open Graph metadata to invitations (#1469)
- 9655ce1c fix: prevent typing indicator timeout for AI agents (#1143)
- 79ae4683 fix: prevent password save prompts for secret fields (#1466)
- f8325ddf feat: drop a dispatch whose comment an in-flight turn already delivered (#1460)
- eab94f3d fix: address topic presence review gaps (#1462)
- d88a88e4 fix: scope typing indicators to topics (#1461)
- c670c6cb fix(orchestration): survive public shares when detecting stuck work (#1458)
- 120df049 fix: record on the waiter which notice speaks for it (#1459)
- fe7af9ed feat: coalesce un-started agent tasks for burst chat messages (#1456)
- 40b298bf feat: make a topic's primary agent an exclusive assignment (#1453)
- edbcf465 fix(markdown): pin header_ids off so heading output does not follow gem defaults (#1449)
- 6c214c97 feat: enable StuckDetector for running task auto-recovery (#1067)
- dde73950 fix(push): cap the FCM notification body and isolate per-device failures (#1447)
- 65125eba test(comments): cover the list_controller.notifyProgrammaticScroll seam (#1408)
- 1fb1920e perf(comments): stop counting whole comment histories for the badge flag (#1444)
- 065b7985 chore(comments): remove the read-pointer helper orphaned by the receipt index (#1443)
- 7d4dcf7b fix(comments): retain failed push deliveries (#1442)
- 2a8e508a perf(comments): move link previews and notifications off the request (#1441)
- f727fb01 perf(comments): move badge recomputation off the request and bound the hot reads (#1440)
- 5d3a2571 perf: batch creative reorder writes (#1439)
- 191bb5df revert: agent/user profile Creatives (Subsystem A) and creator-admin share (#1438)
- 969da432 feat: grant an agent's creator admin on its profile creative (#1437)
- 25184c9f feat: agent/user profile Creatives + system prompt sourced from profile (Subsystem A) (#1412)
- ac03563e fix(comments): order chat timeline by id to survive cross-process clock skew (#1431)
- 010c487e fix: stop sending reasoning_content to strict OpenAI-compatible gateways (Cerebras 400) (#1426)
- 3531ef78 fix: surface masked provider error body; mirror app log level in RubyLLM (#1425)
