module CollavreGithub
  class PullRequestProcessor
    ...
    def call
      ...
      links = CollavreGithub::RepositoryLink.includes(:creative).where(repository_full_name: repo_full_name)
    ...
    def process_link(link)
      ...
      path_exporter = Collavre::Creatives::PathExporter.new(creative, use_effective_origin: false)
      ...
      analyzer = CollavreGithub::PullRequestAnalyzer.new(
        payload: payload,
        creative: creative,
        paths: tree_entries,
