...
class CreativePlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "applies plan tags to creatives via HTML" do
    post collavre_plan_engine.creative_plan_path, params: { plan_id: @plan.id, creative_ids: @creative.id }
  ...
  test "applies plan tags to creatives via JSON" do
    post collavre_plan_engine.creative_plan_path, params: { plan_id: @plan.id, creative_ids: @creative.id }, as: :json
  ...
  test "removes plan tags from creatives via HTML" do
    ...
    delete collavre_plan_engine.creative_plan_path, params: { plan_id: @plan.id, creative_ids: @creative.id }
  ...
  test "removes plan tags from creatives via JSON" do
    ...
    delete collavre_plan_engine.creative_plan_path, params: { plan_id: @plan.id, creative_ids: @creative.id }, as: :json
  ...
  test "returns alert when parameters are missing via HTML" do
    post collavre_plan_engine.creative_plan_path, params: { plan_id: nil, creative_ids: "" }
  ...
  test "returns error when parameters are missing via JSON" do
    post collavre_plan_engine.creative_plan_path, params: { plan_id: nil, creative_ids: "" }, as: :json
