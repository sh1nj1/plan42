module ApplicationHelper
  ...
  EMBED_ALLOWED_ATTRS = %w[src title frameborder allow allowfullscreen style href class alt width height target rel sgid content-type filename colspan rowspan controls preload poster data-ppt-slide data-ppt-width data-ppt-height data-ppt-format].freeze
