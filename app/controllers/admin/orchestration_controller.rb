...
module Admin
  class OrchestrationController < ApplicationController
    ...
    def policies_to_yaml
      policies = Collavre::OrchestratorPolicy.enabled.order(:policy_type, :scope_type, :priority)
    ...
    def apply_policies!(parsed)
      Collavre::OrchestratorPolicy.transaction do
        # Clear existing policies
        Collavre::OrchestratorPolicy.delete_all
