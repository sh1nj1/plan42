if (!window.githubIntegrationInitialized) {
  ...
  document.addEventListener('turbo:load', function () {
    ...
    let webhookDetails = {};
    let geminiPrompt = defaultPrompt;
    ...
    function updateStep() {
      ['github-step-connect', 'github-step-organization', 'github-step-repositories', 'github-step-summary', 'github-step-prompt']
        .forEach(function (id) {
    ...
    function fetchStatus() {
      ...
      fetch(`/creatives/${creativeId}/github_integration`, { headers: { Accept: 'application/json' } })
        ...
        .then(function (data) {
          ...
          geminiPrompt = data.prompt || defaultPrompt;
          if (promptInput) promptInput.value = geminiPrompt;
    ...
    function saveSelection() {
      ...
      fetch(`/creatives/${creativeId}/github_integration`, {
        ...
        .then(function (result) {
          ...
          geminiPrompt = result.body.prompt || defaultPrompt;
          if (promptInput) promptInput.value = geminiPrompt;
          updateSummary();
