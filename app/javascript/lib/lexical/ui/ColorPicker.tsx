...
function isKeyboardInput(event: React.MouseEvent | React.KeyboardEvent): boolean {
  // Simple check - if we needed complex logic we'd import it, but usually this is just
  // creating a boolean flag for history.
  return (event as any).type === 'keydown' || (event as any).type === 'keyup';
}
