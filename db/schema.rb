...
ActiveRecord::Schema[8.1].define(version: 2026_07_21_000010) do
  ...
  create_table "creatives", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_creatives_on_user_id_profile_unique", unique: true, where: "data->>'kind' = 'profile'"
  end
